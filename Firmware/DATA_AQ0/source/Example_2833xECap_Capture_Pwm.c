...
*/
       SampleTable[adc_index++]= ( (AdcRegs.ADCRESULT0)>>4);
...
*/
	   ...
	   R_PT = R_CT;
	   R_CT = ECap1Regs.CAP1;
	   RRPM[array_index] = ((float)150000000*(float)60)/((float)(R_CT-R_PT)*(float)68);
	   R_CRPM = ((float)150000000*(float)60)/(((float)R_CT-(float)R_PT)*(float)68);
