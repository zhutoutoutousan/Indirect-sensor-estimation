...
PAGE 0 :
   ...
   RAML2      : origin = 0x00A000, length = 0x000800
   RAML3      : origin = 0x00A800, length = 0x001000
...
PAGE 1 :
   ...
   RAML4      : origin = 0x00B800, length = 0x002300
   RAML5      : origin = 0x00DB00, length = 0x002000
   RAML6      : origin = 0x00FB00, length = 0x000200
   RAML7      : origin = 0x00FD00, length = 0x000200
   ZONE7B     : origin = 0x20FF00, length = 0x000200     /* XINTF zone 7 - data space */
}
