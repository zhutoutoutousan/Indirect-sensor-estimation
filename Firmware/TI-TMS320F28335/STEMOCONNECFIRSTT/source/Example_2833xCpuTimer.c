...
#include <string.h>
//-----------------Cputimer and stepmotor control-------------------------------
...
//---------------------------Cputimer and Step motor control-----------------------------
...
__interrupt void xint3_isr(void)
{
	START_CON = START;
	DELAY_US(150);
	if(GpioDataRegs.GPBDAT.bit.GPIO60 == 1)START_CON = START;
	DELAY_US(5000000);
...
__interrupt void xint4_isr(void)
{
	START_CON = START;
	DELAY_US(150);
	if(GpioDataRegs.GPBDAT.bit.GPIO61 == 1)START_CON = START;
	DELAY_US(5000000);
	if(GpioDataRegs.GPBDAT.bit.GPIO61 == 0 ) START_CON = STOP;
